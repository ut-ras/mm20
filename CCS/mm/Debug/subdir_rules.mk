...
%.obj: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"C:/ti/ccs930/ccs/tools/compiler/ti-cgt-arm_18.12.4.LTS/bin/armcl" -mv7M4 --code_state=16 --float_support=FPv4SPD16 -me --include_path="C:/Users/zachr/MM20Firmware/mm20/CCS/mm" --include_path="C:/Users/zachr/MM20Firmware/mm20/CCS/mm/inc" --include_path="C:/Users/zachr/MM20Firmware/mm20/CCS/mm" --include_path="C:/ti/tirtos_tivac_2_16_00_08/products/TivaWare_C_Series-2.1.1.71b" --include_path="C:/ti/tirtos_tivac_2_16_00_08/products/bios_6_45_01_29/packages/ti/sysbios/posix" --include_path="C:/ti/ccs930/ccs/tools/compiler/ti-cgt-arm_18.12.4.LTS/include" --define=ccs="ccs" --define=PART_TM4C123GH6PM --define=ccs --define=TIVAWARE -g --c99 --gcc --diag_warning=225 --diag_warning=255 --diag_wrap=off --display_error_number --gen_func_subsections=on --abi=eabi --preproc_with_compile --preproc_dependency="$(basename $(<F)).d_raw" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '

build-1227251505:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1227251505-inproc

build-1227251505-inproc: ../gpiointerrupt.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-1227251505 ../gpiointerrupt.cfg
configPkg/compiler.opt: build-1227251505
configPkg/: build-1227251505
